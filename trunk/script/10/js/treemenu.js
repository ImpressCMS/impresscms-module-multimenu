...
function treemenu(name, showLines, showIcons, useCookies) {                     //>treemenu
 ...
 this.defaults = {                                                              // Default images/icons
   iconRoot  : url+'root.gif',        iconItem  : url+'item.gif',               //    ..        ..
   iconOpen  : url+'open.gif',        iconClose : url+'close.gif',              //    ..        ..
   passLine  : url+'passline.gif',    empty     : url+'empty.gif',              //    ..        ..
   tieLine   : url+'tieline.gif',     tiePlus   : url+'tieplus.gif',            //    ..        ..
   endLine   : url+'endline.gif',     endPlus   : url+'endplus.gif',            //    ..        ..
   rectPlus  : url+'rectplus.gif',    tieMinus  : url+'tieminus.gif',           //    ..        ..
   rectMinus : url+'rectminus.gif',   endMinus  : url+'endminus.gif',           //    ..        ..
   minIcon   : url+'minicon.gif'  } }                                           //
                                                                                // ----------- Build up menu -----------

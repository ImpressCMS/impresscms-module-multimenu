...
config.prototype.toString = function() {                                        //>ToString
 ...
 var icon = (this.tree.showIcons) ? './modules/multiMenu/script/10/gif/config.gif' : './modules/multiMenu/script/10/gif/minicon.gif';       // Decide icon = config- or minIcon.gif
 ...
 str += '<img src="./modules/multiMenu/script/10/gif/empty.gif" alt="" />'                                    // Show Lines:
 ...
 str += '<img src="./modules/multiMenu/script/10/gif/empty.gif" alt="" />'                                    // Show Icons:
 ...
 str += '<img src="./modules/multiMenu/script/10/gif/empty.gif" alt="" />'                                    // Autoclose:
 ...
 str += '<img src="./modules/multiMenu/script/10/gif/empty.gif" alt="" />'                                    // Use Cookies:
 ...
 str += '<img src="./modules/multiMenu/script/10/gif/empty.gif" alt="" /><img src="./modules/multiMenu/script/10/gif/empty.gif" alt="" />'  // Expire period of cookies
 ...
 str += '<img src="./modules/multiMenu/script/10/gif/empty.gif" alt="" />';                                   // Open Level:
 ...
 str += '<img src="./modules/multiMenu/script/10/gif/empty.gif" alt="" />'                                    // Help:
     + '<a href="javascript: ' + this.name + '.help()">'                        //   Icon:
     +  '<img id="' + this.name + 'HelpGif"'                                    //     Write Html-string for the image
     +  ' src="./modules/multiMenu/script/10/gif/help.gif" alt="" /></a>';                                    //     and a reference to this -> toggle
...
config.prototype.changeIcons = function() {                                     //>ChangeIcons (Checkbox Show Icons)
 ...
 icon.src  = (check.checked) ? './modules/multiMenu/script/10/gif/config.gif' : './modules/multiMenu/script/10/gif/minIcon.gif';            // Show or hide main icon of this

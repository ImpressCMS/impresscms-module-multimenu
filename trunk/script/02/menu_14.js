...
if (ie4_14||ns6_14)
document.write('<div id="dropmenudiv14" style="z-index:100;visibility:hidden;width:'+menuwidth14+';background-color:'+menubgcolor14+'" onMouseover="clearhidemenu14()" onMouseout="dynamichide14(event)"></div>')
...
if (menuwidth14<0){
dropmenuobj14.widthobj=dropmenuobj14.style
dropmenuobj14.widthobj.width=-0.8*menuwidth14
}
...
edgeoffset14=dropmenuobj14.contentmeasure-23 //gère la hauteur d'affichage du menu déroulant

...
if (ie4_18||ns6_18)
document.write('<div id="dropmenudiv18" style="z-index:100;visibility:hidden;width:'+menuwidth18+';background-color:'+menubgcolor18+'" onMouseover="clearhidemenu18()" onMouseout="dynamichide18(event)"></div>')
...
if (menuwidth18<0){
dropmenuobj18.widthobj=dropmenuobj18.style
dropmenuobj18.widthobj.width=-0.8*menuwidth18
}
...
var windowedge18=ie4_18 && !window.opera? iecompattest18().scrollLeft+iecompattest18().clientWidth-15 : window.pageXOffset+window.innerWidth-15
...
var windowedge18=ie4_18 && !window.opera? iecompattest18().scrollTop+iecompattest18().clientHeight-15 : window.pageYOffset+window.innerHeight-18
...
edgeoffset18=dropmenuobj18.contentmeasure-23 //gère la hauteur d'affichage du menu déroulant

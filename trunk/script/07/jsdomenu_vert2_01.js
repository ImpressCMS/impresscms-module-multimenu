/*
  ...
  Copyright (C) 2001 - 2001 Toh Zhiqiang
  Released on ??? 2001
...
function menuItemOut() { // Private method
  intervalId = setTimeout("deactivate()", 50); //délai de disparition du menu en ms sauf contextuel
  if (this.enabled) {
...
function initjsDOMenu_vert2_01() { // Public method
  if (document.createElement && document.getElementById) {
	if (document.getElementById("staticMenuv101")) {	createjsDOMenuv01(); }
  }
}

addToStart(initjsDOMenu_vert2_01);
...
function menuItem3() { // Public method
  ...
  if (this.displayText == "{sep}") {
    ...
    this.id = "menuItem" + (++menuItemCount);
    this.className = "jsdomenuitem3"; //indiquer ici en dur la déclaration pour ce type de lien
  }
  this.itemName = "";
  this.actionOnClick = "";
  this.enabled = true;
  this.classNameOver = "jsdomenuitemover3"; //format lien catégorie ou note au passage de la souris
  this.sepClassName = sepClassName;
  var len = arguments.length;
  if (len > 1 && arguments[1].length > 0) {
    this.itemName = arguments[1];
...
function menuItem3b() { // Public method
  ...
  if (this.displayText == "{sep}") {
    ...
    this.id = "menuItem" + (++menuItemCount);
    this.className = "jsdomenuitem3b"; //indiquer ici en dur la déclaration pour ce type de lien
  }
  this.itemName = "";
  this.actionOnClick = "";
  this.enabled = true;
  this.classNameOver = "jsdomenuitemover3b"; //format lien catégorie ou note au passage de la souris
  this.sepClassName = sepClassName;
  var len = arguments.length;
  if (len > 1 && arguments[1].length > 0) {
    this.itemName = arguments[1];
...
// duplication pour liens de type catégorie
function menuItem4() { // Public method
  ...
  if (this.displayText == "{sep}") {
    ...
    this.id = "menuItem" + (++menuItemCount);
    this.className = "jsdomenuitem4"; //indiquer ici en dur la déclaration pour ce type de lien
  }
  this.itemName = "";
  this.actionOnClick = "";
  this.enabled = true;
  this.classNameOver = "jsdomenuitemover4"; //format lien catégorie ou note au passage de la souris
  this.sepClassName = sepClassName;
  var len = arguments.length;
  if (len > 1 && arguments[1].length > 0) {
    this.itemName = arguments[1];
...
//fin duplication pour liens de type catégorie

// duplication pour liens de type catégorie sans lien
function menuItem4b() { // Public method
  ...
  if (this.displayText == "{sep}") {
    ...
    this.id = "menuItem" + (++menuItemCount);
    this.className = "jsdomenuitem4b"; //indiquer ici en dur la déclaration pour ce type de lien
  }
  this.itemName = "";
  this.actionOnClick = "";
  this.enabled = true;
  this.classNameOver = "jsdomenuitemover4b"; //format lien catégorie ou note au passage de la souris
  this.sepClassName = sepClassName;
  var len = arguments.length;
  if (len > 1 && arguments[1].length > 0) {
    this.itemName = arguments[1];
...
//fin duplication pour liens de type catégorie sans lien
...
if (typeof(autoHideTimeLimit) == "undefined") {
  autoHideTimeLimit = 2000; // Public field - délai de disparition du menu contextuel
}

...
if (ie4_19||ns6_19)
document.write('<div id="dropmenudiv19" style="z-index:100;visibility:hidden;width:'+menuwidth19+';background-color:'+menubgcolor19+'" onMouseover="clearhidemenu19()" onMouseout="dynamichide19(event)"></div>')
...
if (menuwidth19<0){
dropmenuobj19.widthobj=dropmenuobj19.style
dropmenuobj19.widthobj.width=-0.8*menuwidth19
}
...
var windowedge19=ie4_19 && !window.opera? iecompattest19().scrollLeft+iecompattest19().clientWidth-15 : window.pageXOffset+window.innerWidth-15
...
var windowedge19=ie4_19 && !window.opera? iecompattest19().scrollTop+iecompattest19().clientHeight-15 : window.pageYOffset+window.innerHeight-19
...
edgeoffset19=dropmenuobj19.contentmeasure-23 //gère la hauteur d'affichage du menu déroulant

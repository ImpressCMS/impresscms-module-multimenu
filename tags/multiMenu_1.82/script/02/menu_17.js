...
if (ie4_17||ns6_17)
document.write('<div id="dropmenudiv17" style="z-index:100;visibility:hidden;width:'+menuwidth17+';background-color:'+menubgcolor17+'" onMouseover="clearhidemenu17()" onMouseout="dynamichide17(event)"></div>')
...
if (menuwidth17<0){
dropmenuobj17.widthobj=dropmenuobj17.style
dropmenuobj17.widthobj.width=-0.8*menuwidth17
}
...
var windowedge17=ie4_17 && !window.opera? iecompattest17().scrollLeft+iecompattest17().clientWidth-15 : window.pageXOffset+window.innerWidth-15
...
var windowedge17=ie4_17 && !window.opera? iecompattest17().scrollTop+iecompattest17().clientHeight-15 : window.pageYOffset+window.innerHeight-18
...
edgeoffset17=dropmenuobj17.contentmeasure-23 //gère la hauteur d'affichage du menu déroulant

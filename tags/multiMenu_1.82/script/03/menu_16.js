...
if (ie4_16||ns6_16)
document.write('<div id="dropmenudiv16" style="z-index:160;visibility:hidden;width:'+menuwidth16+';background-color:'+menubgcolor16+'" onMouseover="clearhidemenu16()" onMouseout="dynamichide16(event)"></div>')
...
var windowedge16=ie4_16 && !window.opera? iecompattest16().scrollLeft+iecompattest16().clientWidth-16 : window.pageXOffset+window.innerWidth-16
...
var windowedge16=ie4_16 && !window.opera? iecompattest16().scrollTop+iecompattest16().clientHeight-16 : window.pageYOffset+window.innerHeight-18

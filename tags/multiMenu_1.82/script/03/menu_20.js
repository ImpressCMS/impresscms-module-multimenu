...
if (ie4_20||ns6_20)
document.write('<div id="dropmenudiv20" style="z-index:200;visibility:hidden;width:'+menuwidth20+';background-color:'+menubgcolor20+'" onMouseover="clearhidemenu20()" onMouseout="dynamichide20(event)"></div>')
...
var windowedge20=ie4_20 && !window.opera? iecompattest20().scrollLeft+iecompattest20().clientWidth-20 : window.pageXOffset+window.innerWidth-20
...
var windowedge20=ie4_20 && !window.opera? iecompattest20().scrollTop+iecompattest20().clientHeight-20 : window.pageYOffset+window.innerHeight-20

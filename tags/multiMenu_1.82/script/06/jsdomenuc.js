...
function menuItemOut() { // Private method
  intervalId = setTimeout("deactivate()", 50);
  if (this.enabled) {
...
function initjsDOMenuc() { // Public method
  if (document.createElement && document.getElementById) {
    createjsDOMenuc();
  }
}

addToStart(initjsDOMenuc);
...
//duplication pour les titres sans url (standard)
...
// fin duplication pour les titres sans url (standard)
...
//fin duplication pour liens de type note
...
className          : Optional. String that specifies the CSS class selector for the menu. Defaults 
                     to "jsdomenudiv".
*/
function jsDOMenuc() { // Public method
...
*/
function activatePopUpMenuByc() { // Public method
...
*/
function setPopUpMenuc(menuObj) { // Public method
